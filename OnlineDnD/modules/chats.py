...
"""<b>{{ =message['me_from'] }}: </b>"""
"""<pre word-wrap="break-word";>{{ =message['me_body'] }}</pre></div>""")

COLOR_MESSAGE_TEMPLATE = ("""<div class="message" id="m{{ =message['id'] }}">"""
"""<b>{{ =message['me_from'] }}: </b>"""
"""<pre word-wrap="break-word" style="color:#2A9e8a";>{{ =message['me_body'] }}</pre></div>""")
